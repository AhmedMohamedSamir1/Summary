...
const swiper = new Swiper(".mySwiper", 
    {
        slidesPerView: 5,   // Number of slides visible at once (default)
        slidesPerGroup: 2,  //  total slides a multiple of slidesPerGroup
  ...
  breakpoints: {
    1200:{ slidesPerView: 5 },  // ≥1200px: show 5 slides
